...
using EntityFerreteria;
using Microsoft.EntityFrameworkCore;

namespace CadFerreteria.DBContext;
...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C09ECD06B");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843FCF8639A6");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483D004B35B");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E1077E8EC8B3");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547E0009E419");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132B205A303");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F7664056F11");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D8007E32DA");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEE680C99EE");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A636DA1A64");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D56146B6C3F53");
